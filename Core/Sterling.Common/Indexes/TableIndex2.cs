...
namespace Wintellect.Sterling.Indexes
{
    ...
    public class TableIndex<T, TIndex1, TIndex2, TKey> : TableIndex<T,GenericTuple<TIndex1,TIndex2>,TKey> where T : class, new()
    {        
        /// <summary>
        ///     Index
        /// </summary>
        ...
        public GenericTuple<TIndex1, TIndex2> TupleIndex { get; private set; }
        ...
        public TableIndex(TIndex1 index1, TIndex2 index2, TKey key, Func<TKey, T> getter) : base(SterlingTuple.Create(index1,index2), key, getter)
        {
            Index1 = index1;
            Index2 = index2;
            TupleIndex = SterlingTuple.Create(index1, index2);
        }

        public TableIndex(TableIndex<T, GenericTuple<TIndex1, TIndex2>, TKey> baseIndex, Func<TKey, T> getter) : base(baseIndex.Index, baseIndex.Key, getter)
        {            
        }
