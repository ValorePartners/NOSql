...
namespace Wintellect.Sterling.Serialization
{
    ...
    public class DefaultSerializer : BaseSerializer 
    {
        ...
        public DefaultSerializer()
        {
            ...
            _serializers.Add( typeof(bool), new GenericTuple<Action<BinaryWriter, object>, Func<BinaryReader, object>>(
                (bw,obj) => bw.Write((bool)obj),
                br => br.ReadBoolean()));

            _serializers.Add(typeof(byte), new GenericTuple<Action<BinaryWriter, object>, Func<BinaryReader, object>>(
            ...
            _serializers.Add(typeof(char), new GenericTuple<Action<BinaryWriter, object>, Func<BinaryReader, object>>(
            ...
            _serializers.Add(typeof(double), new GenericTuple<Action<BinaryWriter, object>, Func<BinaryReader, object>>(
               (bw, obj) => bw.Write((double)obj),
               br => br.ReadDouble()));

            _serializers.Add(typeof(float), new GenericTuple<Action<BinaryWriter, object>, Func<BinaryReader, object>>(
               (bw, obj) => bw.Write((float)obj),
               br => br.ReadSingle()));

            _serializers.Add(typeof(int), new GenericTuple<Action<BinaryWriter, object>, Func<BinaryReader, object>>(
               (bw, obj) => bw.Write((int)obj),
               br => br.ReadInt32()));

            _serializers.Add(typeof(long), new GenericTuple<Action<BinaryWriter, object>, Func<BinaryReader, object>>(
               (bw, obj) => bw.Write((long)obj),
               br => br.ReadInt64()));

            _serializers.Add(typeof(sbyte), new GenericTuple<Action<BinaryWriter, object>, Func<BinaryReader, object>>(
               (bw, obj) => bw.Write((sbyte)obj),
               br => br.ReadSByte()));

            _serializers.Add(typeof(short), new GenericTuple<Action<BinaryWriter, object>, Func<BinaryReader, object>>(
               (bw, obj) => bw.Write((short)obj),
               br => br.ReadInt16()));

            _serializers.Add(typeof(string), new GenericTuple<Action<BinaryWriter, object>, Func<BinaryReader, object>>(
               (bw, obj) => bw.Write((string)obj),
               br => br.ReadString()));

            _serializers.Add(typeof(uint), new GenericTuple<Action<BinaryWriter, object>, Func<BinaryReader, object>>(
               (bw, obj) => bw.Write((uint)obj),
               br => br.ReadUInt32()));

            _serializers.Add(typeof(ulong), new GenericTuple<Action<BinaryWriter, object>, Func<BinaryReader, object>>(
               (bw, obj) => bw.Write((ulong)obj),
               br => br.ReadUInt64()));

            _serializers.Add(typeof(ushort), new GenericTuple<Action<BinaryWriter, object>, Func<BinaryReader, object>>(
