...
namespace Wintellect.Sterling.Serialization
{
    ...
    public class AggregateSerializer : BaseSerializer 
    {
        ...
        /// </summary>
        private readonly Dictionary<Type, GenericTuple<Action<object,BinaryWriter>, Func<BinaryReader,object>>> _serializerCache 
            = new Dictionary<Type, GenericTuple<Action<object,BinaryWriter>, Func<BinaryReader,object>>>();
                ...
                foreach (var serializer in _serializers)
                {
                    if (serializer.CanSerialize(targetType))
                    {
                        ...
                        _serializerCache.Add(targetType,
                            new GenericTuple<Action<object, BinaryWriter>, Func<BinaryReader, object>>(
