...
namespace Wintellect.Sterling.Database
{
    ...
    public abstract class BaseDriver : ISterlingDriver
    {
        ...
        public abstract void SerializeIndex<TKey, TIndex1, TIndex2>(Type type, string indexName,
                                                                    Dictionary<TKey, GenericTuple<TIndex1, TIndex2>> indexMap);
        ...
        /// <param name="indexName">The name of the index</param>        
        /// <returns>The index map</returns>        
        public abstract Dictionary<TKey, GenericTuple<TIndex1, TIndex2>> DeserializeIndex<TKey, TIndex1, TIndex2>(Type type,
                                                                                                           string
                                                                                                               indexName);
