...
namespace Wintellect.Sterling
{
    public interface ISterlingDriver
    {
        ...
        /// <param name="indexName">The name of the index</param>
        /// <param name="indexMap">The index map</param>        
        void SerializeIndex<TKey, TIndex1, TIndex2>(Type type, string indexName, Dictionary<TKey, GenericTuple<TIndex1,TIndex2>> indexMap);
        ...
        /// <param name="indexName">The name of the index</param>        
        /// <returns>The index map</returns>        
        Dictionary<TKey, GenericTuple<TIndex1, TIndex2>> DeserializeIndex<TKey, TIndex1, TIndex2>(Type type, string indexName);
